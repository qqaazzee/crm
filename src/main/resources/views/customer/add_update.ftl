...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item layui-row">
        ...
        <div class="layui-col-xs6">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input"
                       name="satisfaction" value="${(customer.satisfaction)!}"  placeholder="请输入客户信用级别">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item layui-row">
        <div class="layui-col-xs6">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input"
                       name="localTaxNum" value="${(customer.localTaxNum)!}"  placeholder="请输入国税">
            </div>
        </div>
        <div class="layui-col-xs6">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input"
                       name="nationalTaxNum" value="${(customer.nationalTaxNum)!}"  placeholder="请输入地税">
            </div>
        </div>
    </div>
