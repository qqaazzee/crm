layui.use(['table','layer',"form"],function(){
    ...
    var  tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'reputation', title: '满意度', align:'center'},
            {field: 'level', title: '客户级别', align:'center'},
            {field: 'satisfaction', title: '信用度', align:'center'},
            ...
            {field: 'localTaxNum', title: '国税', align:'center'},
            {field: 'nationalTaxNum', title: '地税', align:'center'},
    ...
    $(".search_btn").on("click",function () {
        table.reload("customerListTable",{
            ...
            where:{
                ...
                cusNo:$("input[name='customerId']").val(),// 客户编号
